...
- [ ] **Explain solving techniques in Help** — add a Help section that briefly explains the supported techniques: Naked Single, Hidden Single, Pointing Pair/Triple, Box-Line Reduction, Naked Pair, Hidden Pair, Naked Triple, X-Wing, Swordfish, XY-Wing, and Unique Rectangle. Keep explanations player-friendly and connected to how highlighted pattern/elimination cells appear in hint chains.
...
- Service worker cache is currently `sudoku-v42`.
